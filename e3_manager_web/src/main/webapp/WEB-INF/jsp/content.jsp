	...
	<div class="easyui-layout" data-options="fit:true">
		<div data-options="region:'west',split:false"
			...
			<ul id="contentCategoryTree" class="easyui-tree"
				data-options="url:'${pageContext.request.contextPath }/content/category/list',animate: true,method : 'GET'">
			</ul>
		</div>
		<div data-options="region:'center'" style="padding: 5px">
			<table class="easyui-datagrid" id="contentList"
				data-options="toolbar:contentListToolbar,singleSelect:false,collapsible:true,pagination:true,method:'get',pageSize:20,url:'${pageContext.request.contextPath }/content/query/list',queryParams:{categoryId:0}">
				<thead>
					<tr>
...
var contentListToolbar = [{
    ...
    handler:function(){
    	...
    	E3.createWindow({
			...
			url : "${pageContext.request.contextPath }/item/content-add"
		}); 
    }
},{
    text:'编辑',
