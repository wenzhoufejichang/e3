...
<div id="header">
	<div class="header_inner">
		<div class="logo">
			...
			<div class="index_topad" id="playLogo" style="">
				<a href="/html/activity/1472179566.html" target="_blank"> <img
					src="${pageContext.request.contextPath }/images/html/20160829181637762.gif">
				</a>
			</div>
			...
			<div class="logo-text">
				<img
					src="${pageContext.request.contextPath }/images/html/logo_word.jpg">
			</div>
		</div>
		<div class="index_promo"></div>
		<div class="search">
			<form action="http://localhost:8083/search.html" id="searchForm"
				...
				<input type="text" class="text keyword ac_input" name="keyword"
					...
					autocomplete="off" placeholder="xxx"> <input type="button"
					value="" class="submit" onclick="search_keys('searchForm')">
			</form>
		...
		<div class="shopingcar" id="topCart">
			<s class="setCart"></s><a href="http://localhost:8089/cart/cart.html"
