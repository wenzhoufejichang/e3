						...
						<form id="formlogin" method="post">
							...
							<li><span class="title">手机/验证邮箱/用户名<font
								...
								<span class="border" style="position: relative"> <input
									...
									class="new-input1 new-color" tabindex="1" data-clear-btn="true"
									id="loginname" size="25" autocomplete="off" htmlescape="true"
									title="请输入用户名"> <em class="icon1" id="usernamelogo"></em>
									<span
							...
							<li class="m-t12"><span class="title">登录密码</span> <span
								class="border" style="position: relative"> <input
									...
									style="position: absolute; font-size: 14px; left: 5px; top: 9px; display: none;"
									class="sfbest_password_place">密码</span></span> <span id="sfbestPwdErr"></span></li>
							<div class="clear"></div>
							<li>
		...
		var LOGIN = {
			...
			doLogin : function() {
				$.post("${pageContext.request.contextPath }/user/login", $(
						"#formlogin").serialize(), function(data) {
					if (data.status == 200) {
